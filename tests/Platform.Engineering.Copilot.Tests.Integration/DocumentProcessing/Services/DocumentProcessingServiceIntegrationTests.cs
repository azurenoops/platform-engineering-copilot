    ...
    public class DocumentProcessingServiceIntegrationTests : IAsyncLifetime
    {
        ...
        public async Task InitializeAsync()
        {
            ...
            mockDiagramAnalyzer
                ...
                {
                    DetectedPatterns = new List<ArchitecturePattern>
                    {
                        new ArchitecturePattern { Name = "Microservices", Description = "Distributed services pattern", Confidence = 0.85 }
                    },
                    SystemComponents = new List<SystemComponent>
                    {
                        new SystemComponent { Name = "Web Server", Type = "Server", Description = "IIS-based web server" },
                        new SystemComponent { Name = "Database", Type = "Database", Description = "SQL Server database" }
                    },
                    DataFlows = new List<DataFlow>
                    {
                        new DataFlow { Source = "Web Server", Target = "Database", DataType = "SQL", Classification = SecurityClassification.Confidential }
                    },
                    TechnologyStack = new List<string> { "IIS", "SQL Server", ".NET" },
                    Recommendations = new List<ArchitectureRecommendation>
                    {
                        new ArchitectureRecommendation { Title = "Add caching layer", Description = "Improve performance", Priority = Priority.Medium }
                    }
                });

            mockDiagramAnalyzer
                .Setup(a => a.ExtractDiagramsAsync(It.IsAny<string>()))
                .ReturnsAsync(new List<ExtractedDiagram>
                {
                    new ExtractedDiagram
                    {
                        Title = "System Architecture",
                        DiagramType = "Architecture",
                        ExtractedText = "Architecture diagram content",
                        PageNumber = 1
                    }
                });
            ...
            mockComplianceEngine
                .Setup(e => e.RunComprehensiveAssessmentAsync(It.IsAny<string>(), It.IsAny<IProgress<AssessmentProgress>>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync(new AtoComplianceAssessment
                {
            ...
            mockRemediationEngine
                .Setup(e => e.GenerateRemediationPlanAsync(It.IsAny<string>(), It.IsAny<List<AtoFinding>>(), It.IsAny<RemediationPlanOptions>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync(new RemediationPlan
                {
                    ...
                    RemediationItems = new List<RemediationItem>
                    {
                        new RemediationItem
                        {
                            ...
                            ControlId = "AC-2",
                            Description = "Missing user account management",
                            RecommendedAction = "Implement user account management procedures",
        ...
        [Fact]
        public async Task ProcessDocument_TextFile_CompletesFullWorkflow()
        {
            // Arrange
            ...
            var result = await _documentProcessingService!.ProcessDocumentAsync(
                file,
                DocumentAnalysisType.ComplianceDocument);
        ...
        [Fact]
        public async Task ProcessDocument_WithFullAnalysis_ExtractsAndAnalyzesContent()
        {
            // Arrange
        ...
        [Fact]
        public async Task ProcessDocument_TextFile_ExtractsFullContent()
        {
            // Arrange
        ...
        [Fact]
        public async Task ProcessDocument_MarkdownFile_PreservesStructure()
        {
            // Arrange
        ...
        [Fact]
        public async Task ProcessDocument_ExtractsBasicMetadata()
        {
            // Arrange
        ...
        [Fact]
        public async Task ProcessDocument_MultipleFiles_MaintainsUniqueMetadata()
        {
            // Arrange
            ...
            // Act
            var result1 = await _documentProcessingService!.ProcessDocumentAsync(file1, DocumentAnalysisType.General);
            var result2 = await _documentProcessingService.ProcessDocumentAsync(file2, DocumentAnalysisType.General);
        ...
        [Fact]
        public async Task GetProcessingStatus_AfterUpload_ReturnsCorrectStatus()
        {
            // Arrange
            var file = CreateMockFormFile("status-test.txt", "Status test content");
            var result = await _documentProcessingService!.ProcessDocumentAsync(file, DocumentAnalysisType.General);
        ...
        [Fact]
        public async Task GetProcessingStatus_InvalidDocumentId_ThrowsException()
        {
            // Act & Assert
        ...
        [Fact]
        public async Task ProcessDocument_SecurityDocument_PerformsSecurityAnalysis()
        {
            // Arrange
            ...
            var result = await _documentProcessingService!.ProcessDocumentAsync(
                file,
                DocumentAnalysisType.SecurityDocument);
        ...
        [Fact]
        public async Task ProcessDocument_ComplianceDocument_PerformsComplianceAnalysis()
        {
            // Arrange
        ...
        [Fact]
        public async Task ProcessDocument_ArchitectureDiagram_PerformsArchitectureAnalysis()
        {
            // Arrange
        ...
        [Fact]
        public async Task ProcessDocument_EmptyFile_HandlesGracefully()
        {
            // Arrange
        ...
        [Fact]
        public async Task ProcessDocument_LargeTextFile_ProcessesSuccessfully()
        {
            // Arrange
        ...
        [Fact]
        public async Task ProcessDocument_MultipleDocuments_ProcessedIndependently()
        {
            // Arrange
            ...
            var results = await Task.WhenAll(
                _documentProcessingService!.ProcessDocumentAsync(file1, DocumentAnalysisType.General),
                _documentProcessingService.ProcessDocumentAsync(file2, DocumentAnalysisType.General),
                _documentProcessingService.ProcessDocumentAsync(file3, DocumentAnalysisType.General)
            );

            // Assert
            results.Should().HaveCount(3);
            results.Select(r => r.DocumentId).Should().OnlyHaveUniqueItems();
            results.All(r => r.ProcessingStatus == ProcessingStatus.Complete).Should().BeTrue();
        }

        [Fact]
        public async Task GetDocumentAnalysis_MultipleDocuments_ReturnsCorrectAnalysis()
        {
            // Arrange
        ...
        [Fact]
        public async Task PerformRmfAnalysis_WithDocumentId_ReturnsComplianceResult()
        {
            // Arrange
            ...
            var result = await _documentProcessingService!.ProcessDocumentAsync(file, DocumentAnalysisType.ComplianceDocument);
            ...
            complianceResult.OverallStatus.Should().NotBe(default(ComplianceStatus));
        }
