...
public class SystemIntegrityEvidenceCollector : IEvidenceCollector
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var vmExtensions = resources.Where(r => 
            ...
            r.Name?.Contains("Antimalware", StringComparison.OrdinalIgnoreCase) == true).ToList();
        ...
        if (vmExtensions.Any())
        {
            evidence.Add(new ComplianceEvidence
            {
                ...
                Data = new Dictionary<string, object>
                {
                    ...
                    {
                        name = ext.Name,
                        resourceGroup = ext.ResourceGroup
                    }).ToList()
                }
            });
        }
        ...
        var updateManagement = resources.Where(r => 
            r.Type?.Contains("Automation", StringComparison.OrdinalIgnoreCase) == true).ToList();
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var monitoringResources = resources.Where(r => 
            r.Type?.Contains("Insights", StringComparison.OrdinalIgnoreCase) == true ||
            r.Type?.Contains("Monitor", StringComparison.OrdinalIgnoreCase) == true).ToList();
